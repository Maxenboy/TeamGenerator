class HomeController < ApplicationController
  ...
  def shuffle
  	...
  	redirect_to home_index_path(page: :result, radio: params[:radio], team_names: params[:animal])
  end
  ...
  def user_shuffled_date_chart
    render json: Namelist.recent.user_lists(user_uuid)
                         .group_day_created_count
  end

  def all_shuffled_date_chart
    render json: Namelist.recent.all.group_day_created_count
  end
end
